        ...
        <div className="max-w-md mx-auto mt-10 p-8 bg-white rounded-lg shadow-xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                    ...
                    required
                    className="w-full px-4 py-2 border border-blue-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-grey-900"
                    />
                </div>
